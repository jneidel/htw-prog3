...
public class LicensedAudioVideo extends AudioVideo implements LicensedAudioVideoI {
    ...
    public LicensedAudioVideo(String address, long bitrate, Duration length, BigDecimal size, Uploader uploader, int samplingRate, String audioEncoding, int width, int height, String videoEncoding, String holderName ) {
